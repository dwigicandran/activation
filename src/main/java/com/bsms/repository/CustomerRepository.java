...
public interface CustomerRepository extends CrudRepository<Customer, Long> {
	...
	@Modifying(clearAutomatically = true)
	@Query(value = "update Customer set tak = :tak, machex = :machex where msisdn in (:msisdn1,:msisdn2)")
	void updateCustByMsisdn(@Param("tak") String tak,@Param("machex") String machex, @Param("msisdn1") String msisdn1,@Param("msisdn2") String msisdn2);
